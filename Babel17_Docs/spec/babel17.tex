...
match (typeof a) $\sim$ (typeof b)
  ...
  case _ => 
    $\emph{if a can be automatically converted to something of the type of b,} $
    $\emph{or else if b can be automatically converted to something of the type of a,}$
    $\emph{then do the conversion and proceed like above with the comparison.}$
end
\end{babellisting}
...
\subsection{Automatic Type Conversions}
...
\end{table}
Note that some of these type conversions are automatic, and some are not.
