...
to & downto & true & false & nil & infinity &  & 
\end{tabular}
\end{center}
...
$a$ \verb!+! $b$ & \babelsrc{$a$.plus $\ b$} \\\hline
$a$ \verb!-! $b$ & \babelsrc{$a$.minus $\ b$} \\\hline
\verb!-! $a$ & \babelsrc{$a$.uminus} \\\hline
$a$ \verb!*! $b$ & \babelsrc{$a$.times  $\ b$} \\\hline
$a$ \verb!/! $b$ & \babelsrc{$a$.div  $\ b$} \\\hline
$a$ \verb!%! $b$ & \babelsrc{$a$.mod  $\ b$} \\\hline
$a$ \verb+^+ $b$ & \babelsrc{$a$.pow  $\ b$} \\\hline
$a$ \verb!++! $b$ & \babelsrc{$a$.plusplus $\ b$} \\\hline
$a$ \verb!--! $b$ & \babelsrc{$a$.minusminus $\ b$} \\\hline
$a$ \verb!**! $b$ & \babelsrc{$a$.timestimes  $\ b$}\\\hline
$a$ \verb!to! $b$ & \babelsrc{$a$.to  $\ b$}\\\hline
$a$ \verb!downto! $b$ & \babelsrc{$a$.downto  $\ b$}\\\hline
