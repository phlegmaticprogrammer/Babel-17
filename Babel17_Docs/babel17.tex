...
\title{Syntax and Semantics of Babel-17, v0.22 (Draft)}
\author{Steven Obua}
\date{\today}                                          
...
\end{itemize}
There is no such language out there. Therefore I decided to create one. When Babel-17 will have reached v1.0 then the above goals will have been achieved. The version described in this document is Babel-17 v0.22, so there is still some distance to go. 
